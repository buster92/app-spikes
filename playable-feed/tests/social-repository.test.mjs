...
const corruptions = [
  ...
  ["self-referential original lineage", (state) => { const post = state.posts.find((item) => item.lineage); post.lineage.originalPostId = post.id; }],
  ["self-referential parent lineage", (state) => { const post = state.posts.find((item) => item.lineage); post.lineage.parentPostId = post.id; }],
  ["unrelated root parent lineage", (state) => { state.posts.find((item) => item.lineage).lineage.parentPostId = "post_alex_meteor"; }],
